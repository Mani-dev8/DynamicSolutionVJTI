...
<div class="Main flex justify-center items-center h-screen bg-violet-200">
    <div class="sub  grid grid-cols-1 rounded-xl w-[95%]  bg-white sm:grid-cols-2">
        ...
        <div class=" flex flex-col items-center justify-center bg-violet-500 rounded-l-xl w-[100%] sm:w-[70%]">
            ...
            <p class="m-4 pt-[10px] indent-2 text-white"> Enter your personal details <br>and start your journey with us</p>
        ...
        <div class="content flex justify-center  w-[100%] sm:w-[70%]">
            <div class=" p-11 flex flex-col items-center text-[#00bdaa] ">
                <h1 class="text-center font-bold text-purple-500 text-3xl">Create Account</h1>
                <img src="login-images\delete (1).png" class="text-center h-9 w-14">

                <div class="google-btn flex gap-4 bg-white px-3 py-2 my-5 border-2 cursor-pointer rounded-lg hover:text-blue-500" onclick="signIn()">
                ...
                <button class="p-2 m-2 border-2 rounded-lg  bg-purple-600 shadow-lg shadow-purple-400 text-white w-[200px]">SIGN UP</button>
            </div>
        </div>
    </div>
</div>
