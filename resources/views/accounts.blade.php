...
<div class="mx-4 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-auto">
    <div class="flex flex-row items-center justify-between border-b ">
        ...
        <div class="flex flex-row items-center justify-center gap-2 ">
            <div class="flex hover:text-violet-800  cursor-pointer text-gray-400  flex-row items-center justify-center"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
        ...
        <div class="col-span-12 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
            ...
            <div class="amx-auto mb-10 overflow-hidden rounded-lg border bg-white">
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <tr>
                            <td class="border-b py-2 text-center text-sm pl-2">23-02-2023</td>
                            <td class="border-b py-2 text-center text-sm px-4">Appliance repaired by technician Suraj Singh between 10am - 1pm </td>
                            <td class="border-b py-2 text-center text-sm">$99.00</td>
                            <td class="border-b py-2 text-center text-sm pr-2"><button class="text-sm text-blue-600 underline">PDF</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
